...
<div class="row">
			<div class="col-lg-12">
               ...
               <div class="panel-heading"> <td width="90%" align="left" valign="top">  <a href="rctracker.php?rccwt_id=1"> <button name="weekly" class="btn btn-primary">Weekly</button></a></td>  <td width="90%" align="left" valign="top">  <a href="rctracker.php?rccmt_id=1"> <button name="monthly" class="btn btn-primary">Monthly</button></a></td> </div>
