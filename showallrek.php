...
<div class="row">
			<div class="col-lg-12">
				...
				<div class="panel-heading"> <td width="90%" align="left" valign="top"> <form action="" method="post"><input name="date" id="datepicker"> <button name="submit" class="btn btn-primary">Submit</button></td> <td> Current date: <?php if($olddate==1) { echo date("m/d/y",strtotime($curdate)); } else { echo date("m/d/y",strtotime($curdate)); } ?> </div>
