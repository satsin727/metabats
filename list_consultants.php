    ...
    <tr>
    	...
    	<td> 
    		<a href="consultantdetails.php?add=marketdetails&id=<?php echo $row['cid']; ?>">Marketing</a>
    				...
    				<?php if($dta['level'] == 1)
{ ?> <a href ="addcomment.php?conscom_id=<?php echo $row['cid']; ?>" onclick="window.open(this.href,'popupwindow','toolbar=no,location=no,status=no,menubar=no,scrollbars=no,resizable=no,height=400,width=400,addressbar=no'); return false;"><img src="images/b_drop.png" alt="Delete" width="16" height="16" border="0" title="Delete"/></a> <?php } ?>
