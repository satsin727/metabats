    ...
    <div class="panel-body">
        ...
        ?>
            ...
            <table class="table table-bordered table-hover">
                ...
                <tbody>
                    <?php
                    $dailyUserCondition = $isRecruiter
                        ? " AND s.uid = :report_uid "
                        : "";
                    ...
                    $dailyParams = [':fdate' => $filter_date];

                    if ($isRecruiter) {
                        $dailyParams[':report_uid'] = $report_uid;
                    }
            ...
            <table class="table table-bordered table-hover text-center">
                ...
                <tbody>
                    ...
                    $weeklySql = "SELECT u.uid, u.name,
                        ...
                        " . ($isRecruiter ? " AND s.uid = :report_uid " : "") . "
                        GROUP BY u.uid, u.name
                    ...
                    if ($isRecruiter) {
                        $weekParams[':report_uid'] = $report_uid;
                    }
        ...
        ?>
            ...
            <table class="table table-bordered table-hover">
                ...
                <tbody>
                    ...
                    if ($isRecruiter) {
                        $monthParams[':report_uid'] = $report_uid;
                    }
...
<div class="panel panel-info">
    <div class="panel-heading">
        <?php
        if ($isRecruiter) {
            echo "My Call Details";
        } else {
            echo ($view_uid == 0)
                ? "Team-Wide Call Details & Export"
                : "User Call Details & Export";
        }
        ?>
    </div>
    <div class="panel-body">
        ...
        <table class="table table-bordered table-striped" data-toggle="table" data-pagination="true" data-search="true">
            ...
            <tbody>
                ...
                /*
                 * Recruiters are always restricted to their own UID.
                 * Admin / Manager keep existing view_uid / Team Total behavior.
                 */
                if ($isRecruiter) {
                    $detailConds .= " AND s.uid = :uid ";
                    $detailParams[':uid'] = $report_uid;
                } elseif ($view_uid > 0) {
                    $detailConds .= " AND s.uid = :uid ";
