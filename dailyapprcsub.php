        ...
        <div class="col-sm-9 col-sm-offset-3 col-lg-10 col-lg-offset-2 main">			
                <div class="row">
                    <ol class="breadcrumb">
                        ...
                        <li class="active">Realtime Daily App/RC/Sub</li>
                    </ol>
                </div><!--/.row-->
                    ...
                    $i=1;
                                        foreach( $data as $row) { ?>
                                            <tr>
                                                ...
                                                <td data-search="<?php echo $row['dateadded']; ?>"> <?php $time = strtotime($row['dateadded']); $myFormatForView = date("m/d/y", $time); echo $myFormatForView; ?></td>
                                                <td> <?php $interval=date_diff(date('d-m-y h:i:s'), strtotime($row['dateadded'])); echo $interval->format('%d');?> </td>
                                                <td data-search="<?php echo $row['cmvisa']; ?>"> <?php echo $row['cmvisa']; ?></td>
                                                <td> <?php $time = strtotime($row['dob']); $myFormatForView = date("m/d/y", $time); echo $myFormatForView; ?></td>
                                                ...
                                                <td> <?php echo $row['rc_num']; ?></td>
                                                <td> <?php echo $row['sub_num']; ?></td>
                                                <td> <?php echo $row['eci_num']; ?></td>
                                            </tr>
                                                    <?php
                                                }
                    ?>
