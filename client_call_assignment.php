...
Showing the first <strong>500</strong> clients.

Use Search to find any client in the database.
...
data-company="<?php echo htmlspecialchars($row['companyname']); ?>">
...
<?php echo htmlspecialchars($row['remail']); ?>

</td>

<td>

<?php echo htmlspecialchars($row['rphone']); ?>
...
<?php echo htmlspecialchars($row['rlocation']); ?>

</td>

<td>

<?php echo htmlspecialchars($row['rtimezon']); ?>

</td>

<td>

<?php echo htmlspecialchars($row['tier']); ?>
...
echo empty($row['called_by'])

? "-"

: htmlspecialchars($row['called_by']);
...
function updateSelectedCount()
{
    document.getElementById("selectedCount").innerHTML =
        document.querySelectorAll(".clientCheck:checked").length;
}

// Runs for dynamically created checkboxes
