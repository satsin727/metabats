                            ...
                            if(isset($smname)) { $sep = "\n"; }
                               ...
                               */
								...
								if($sreqid == $reqid && $ssmid == $uid)
								{
									...
									$sreqid = $reqid;
									$ssmid = $uid ;
                                    $com_query = "SELECT * FROM comments WHERE (com_postid = $reqid AND reqcom_id = 1) OR (com_postid = $appid AND appcom_id = 1) OR (com_postid = $appid AND rccom_id = 1) OR (com_postid = $appid AND subcom_id = 1) OR (com_postid = $appid AND ecicom_id = 1) order by uid asc";
